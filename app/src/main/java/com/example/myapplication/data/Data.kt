...
object Data {
    ...
    private val favoriteData: MutableList<Item> =
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            mutableListOf(
                Item(title="(No Title)", display_sitename="티스토리", image_url="https://blog.kakaocdn.net/dn/deu5VO/btsu0t56Rwg/2eFeBJxsDbVBomId0R9sk1/img.jpg", datetime=Date(), isFavorite=true)
            )
        } else {
            mutableListOf()
        }
